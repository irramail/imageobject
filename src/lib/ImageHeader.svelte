...
<ol class="list-decimal mt-4 px-4">
	<li>Заполнить все однострочные поля.</li>
	<li>Отметить форматы изображения.</li>
	<li>Нажать кнопку Submit, чтобы сохранить и отправить настройки на сервер.</li>
	<li>Нажать на кнопку "Выберите или перенесите файл" и выбрать изображение формата JPG.</li>
	<li>Подождать пока в многострочном текстовом поле появится сгенерированный html текст.</li>
	<li>
		Чтобы скачать архив с изображениями, следует нажать на кнопку скачать (расположена внизу
		рабочей области).
	</li>
	<li>
